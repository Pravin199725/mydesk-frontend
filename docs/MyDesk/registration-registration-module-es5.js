...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["registration-registration-module"], {
  ...
  function srcAppRegistrationRegistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_storage_storage_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    function RegistrationComponent_div_6_li_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function RegistrationComponent_div_15_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function RegistrationComponent_div_19_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function RegistrationComponent_div_19_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    var RegistrationComponent = /*#__PURE__*/function () {
      function RegistrationComponent(formBuilder, authService, socialAuthService, storageService) {
      ...
      _createClass(RegistrationComponent, [{
        ...
        value: function signUpWithGoogle() {
          var _this = this;

          this.socialAuthService.signIn(angularx_social_login__WEBPACK_IMPORTED_MODULE_3__["GoogleLoginProvider"].PROVIDER_ID).then(function (user) {
            ...
            _this.onRegisterHandler(userInfo);
        ...
        key: "signUpWithFB",
        value: function signUpWithFB() {
          var _this2 = this;

          this.socialAuthService.signIn(angularx_social_login__WEBPACK_IMPORTED_MODULE_3__["FacebookLoginProvider"].PROVIDER_ID).then(function (user) {
            var userInfo = {
              email: user.email
            };

            _this2.onRegisterHandler(userInfo);
          })["catch"](function (error) {
            console.log('error', error);
          });
        } // void
        ...
        value: function onRegisterHandler(data) {
          var _this3 = this;

          this.authService.registration(data).subscribe(function (user) {
            _this3.registrationForm.reset();

            _this3.registrationForm.get('email').clearValidators();

            _this3.registrationForm.get('email').updateValueAndValidity();

            _this3.registrationForm.get('password').clearValidators();

            _this3.registrationForm.get('password').updateValueAndValidity();

            _this3.registrationForm.get('confirmPassword').clearValidators();

            _this3.registrationForm.get('confirmPassword').updateValueAndValidity();

            _this3.storageService.setData('userData', user);

            _this3.errors = [];
          }, function (errors) {
            Object.keys(errors.error).map(function (k) {
              return _this3.errors = [].concat(_toConsumableArray(_this3.errors), _toConsumableArray(errors.error[k]));
            });
          });
        }
      }, {
    ...
    RegistrationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function RegistrationComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function RegistrationComponent_Template_form_ngSubmit_7_listener() {
            return ctx.signUp();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegistrationComponent_Template_button_click_25_listener() {
            return ctx.signUpWithFB();
          });
  ...
  function srcAppRegistrationRegistrationModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _registration_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    RegistrationModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _registration_routing_module__WEBPACK_IMPORTED_MODULE_2__["RegistrationRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], angularx_social_login__WEBPACK_IMPORTED_MODULE_5__["SocialLoginModule"]]]
    });
