...
@NgModule({
  declarations: [HomeComponent, StudentHeaderComponent,
    ...
    GradeComponent, MessageComponent, CourseComponent, TimetableComponent, WeekviewComponent, DayviewComponent, LectureComponent, AssignmentComponent, QuizComponent],
  imports: [
    CommonModule,
